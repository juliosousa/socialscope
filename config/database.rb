Mongoid.load!(File.join(Padrino.root, 'config', 'database.yaml'), Padrino.env)
...
#   when :development then 'socialscopeme_development'
#   when :production  then 'socialscopeme_production'
#   when :test        then 'socialscopeme_test'
# end
...
# #       default:
# #         database: socialscopeme_development
# #         hosts:
# #           - localhost:27017
# #
# #   production:
# #     clients: #Replace clients with sessions to work with Mongoid version 3.x or 4.x
# #       default:
# #         database: socialscopeme_production
# #         hosts:
# #           - localhost:27017
# #
# #   test:
