...
database_name = case Padrino.env
  when :development then 'socialscope_development'
  when :production  then 'socialscope_production'
  when :test        then 'socialscope_test'
end
...
#       default:
#         database: socialscope_development
#         hosts:
#           - localhost:27017
#
#   production:
#     clients: #Replace clients with sessions to work with Mongoid version 3.x or 4.x
#       default:
#         database: socialscope_production
#         hosts:
#           - localhost:27017
#
#   test:
